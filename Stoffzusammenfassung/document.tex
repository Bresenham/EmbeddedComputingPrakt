...
\begin{itemize}
	...
	- Lesen und Schreiben (\textit{read} und \textit{write})\\
	\hspace*{1em}$write(fd, \&value, sizeof(value));$\\
	- Konfigurieren (\textit{ioctl})\\
	...
	\hspace*{1em}\hspace*{1em}oder \textit{analoge} Schnittstelle)\\
	\hspace*{1em}$fd = open('Tuer', O\_RDWR);$\\
	\hspace*{1em}$...$\\
	\hspace*{1em}$close(fd);$
